...
<div class="background-fabrica">
    <div class="alinhamento">
        <h3 id="sobre" class="titulo-principal text-center">Sobre nós</h3>
        <div class="card-container fabrica">
            <!-- Card 1 -->
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
                        <img class="icons" src="assets/imagens/fundador.png" alt="Fundador da Brasmol">
                    </div>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
                        <img class="icons" src="assets/imagens/fundador2.png" alt="Fundador da Brasmol 2">
                    </div>
                    <div class="flip-card-back">
                        <h2>FIM DOS ANOS 40</h2>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
                        <img class="icons" src="assets/imagens/fabrica.png" alt="Fábrica Brasmol">
                    </div>
                    <div class="flip-card-back">
                        <h2>ENTRE OS ANOS 60 E 70</h2>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        <h2>ANOS 80</h2>
                        <p>Em meados dos anos 80 a empresa se instalou numa grande área em Itaquaquecetuba – 35 km do Centro de São Paulo. Sua área construída, hoje, dobrou de tamanho para mais 5.000 m².</p>
                    </div>
                </div>
            </div>
