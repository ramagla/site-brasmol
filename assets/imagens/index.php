...
<head>
    ...
    <script>
        ...
        gtag('event', 'conversion', {'send_to': 'AW-395261678/Vy-0CL6hlb4CEO7tvLwB'});
    </script>
</head>      
<body>
...
<div class="orcamento container mt-4">
    ...
    <div class="background-fabrica">
        ...
        <div class="fabrica">
            <h3 class="titulo-principal">Nossa Fábrica</h3>
            <ol>
                <li>
                    <figure>
                        <img class="icons" src="imagens/cnc.svg" alt="Máquinas CNC">
                        <p class="iconsp">Máquinas automáticas de última geração (CNC) para produção de molas.</p>
                    </figure>
                    <figure>
                        <img class="icons" src="imagens/maquinas.svg" alt="Máquinas automáticas">
                        <p class="iconsp">Máquinas automáticas para conformação de metais e prensas para estampagem de peças maiores.</p>
                    </figure>
                    <figure>
                        <img class="icons" src="imagens/sala.svg" alt="Sala com temperatura controlada">
                        <p class="iconsp">Sala com temperatura controlada para produção de peças específicas.</p>
                    </figure>
                    <figure>
                        <img class="icons" src="imagens/demarcacao.svg" alt="Áreas demarcadas">
                        <p class="iconsp">Áreas demarcadas, locais identificados para peças prontas, matéria-prima e sucata.</p>
                    </figure>
                    <figure>
                        <img class="icons" src="imagens/corredores.svg" alt="Corredores livres">
                        <p class="iconsp">Corredores livres para circulação e movimentação de caixas plásticas para transporte de peças e piso limpo.</p>
                    </figure>
                    <figure>
                        <img class="icons" src="imagens/organizacao.svg" alt="Organização">
                        <p class="iconsp">Organização, limpeza e disciplina; fatores motivacionais também para seus colaboradores.</p>
                    </figure>
                </li>
            </ol>
        </div>
        ...
        <div class="qualidades">
            <div class="background-fabrica">
                <ol>
                    <figure>
                        <li>
                            <img class="icons" src="imagens/mola.svg" alt="Mola">
                            <p class="iconsp">Matéria-prima de qualidade</p>
                        </li>
                    </figure>
                    <figure>
                        <li>
                            <img class="icons" src="imagens/mola.svg" alt="Mola">
                            <p class="iconsp">Anos de tradição</p>
                        </li>
                    </figure>
                    <figure>
                        <li>
                            <img class="icons" src="imagens/mola.svg" alt="Mola">
                            <p class="iconsp">Profissionais Experientes</p>
                        </li>
                    </figure>
                </ol>
            </div>
 ...
 <footer id="rodape">
  <ol>
    <li>
      ...
      <p>Est. Bonsucesso, 1953 - Rio Abaixo</p>
      <p>Itaquá, SP - CEP 08579-000</p>
      <a href="https://www.google.com/maps/place/Est.+Bonsucesso,+1953+-+Rio+Abaixo,+Itaquaquecetuba+-+SP,+08579-000" target="_blank" class="map-link">
        <img src="https://maps.googleapis.com/maps/api/staticmap?center=-23.479815,-46.328367&zoom=14&size=300x150&key=YOUR_GOOGLE_MAPS_API_KEY" alt="Mapa da localização" class="map-thumbnail">
      </a>
    </li>
    <li>
      <h3>Redes Sociais</h3>
  ...
  <div class="end">
    <figure id="logo2">
      <img src="imagens/brasmol-logo-white.png" alt="Logotipo Brasmol">
    </figure>
    <p>© <span id="current-year"></span> Todos os direitos reservados</p>
    
    <a href="https://servidor-estaticos-teal-ten.vercel.app/politica_de_privacidade.pdf">Política de privacidade</a>
  </div>
</footer>
